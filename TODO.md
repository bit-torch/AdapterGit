...
| 4.6 | 命令自动转换 | P2 | ⏳ 待开始 | AI 中自然语言→git 命令 |
...
| 8.3 | `blame` | 逐行追溯 | P2 | ⏳ 待开始 | |
| 8.4 | `reflog` | 引用日志 | P2 | ⏳ 待开始 | |
| 8.5 | `bisect` | 二分查找引入 bug 的提交 | P2 | ⏳ 待开始 | |
...
| ID | 任务 | 优先级 | 状态 | 备注 |
|----|------|--------|------|------|
| 9.1 | 静态编译 (musl) | P1 | ⏳ 待开始 | |
| 9.2 | Linux 安装包 (.deb/.rpm) | P2 | ⏳ 待开始 | |
| 9.3 | macOS 安装包 (.dmg / Homebrew) | P2 | ⏳ 待开始 | |
| 9.4 | Windows 安装包 (.msi / Scoop) | P2 | ⏳ 待开始 | |
| 9.5 | Docker 镜像 | P2 | ⏳ 待开始 | |
| 9.6 | CI/CD 自动发布流水线 | P1 | ⏳ 待开始 | |
...
| **v0.10.0** | **SSH 传输协议** | 🚀 **当前** | SSH 传输 (子进程), Transport trait |
| **v0.11.0** | **Blame + Reflog** | 🎯 **下一阶段** | blame, reflog, Git protocol v2 |
