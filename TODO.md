...
| 2.6 | Tag 对象实现 | P1 | ⏳ 待开始 | v0.4.0 |
| 2.7 | 对象存储 | P0 | ✅ 已完成 | loose objects 读写, 压缩存储 |
| 2.8 | 引用系统 | P0 | ✅ 已完成 | HEAD 符号/分离引用, 分支 CRUD |
...
| ID | 任务 | 优先级 | 状态 | 备注 |
|----|------|--------|------|------|
| 7.1 | 单元测试 | P0 | 🔨 进行中 | hash / compression / blob / tree / commit / index / refs 已覆盖 |
| 7.2 | 集成测试 | P0 | ⏳ 待开始 | 端到端工作流 |
...
| v0.3.0 | 网络功能 (clone/push/pull/fetch/remote) | ✅ 当前版本 |
| v0.4.0 | Tag 对象 + 命令自动转换 + 配置文件 | ⏳ 下一版本 |
